...
public class Constants {
    ...
    public static final Color CIRCLE_EASY_COLOR = Color.CYAN;
    public static final Color CIRCLE_MEDIUM_COLOR = Color.BLUE;
    public static final Color CIRCLE_HARD_COLOR = Color.MAGENTA;
    ...
    public static final Vector2 CIRCLE_EASY_CENTER = new Vector2(DIFFICULTY_WORLD_SIZE / 4, DIFFICULTY_WORLD_SIZE / 2);
    public static final Vector2 CIRCLE_MEDIUM_CENTER = new Vector2(DIFFICULTY_WORLD_SIZE / 2, DIFFICULTY_WORLD_SIZE / 2);
    public static final Vector2 CIRCLE_HARD_CENTER = new Vector2(DIFFICULTY_WORLD_SIZE * 0.75f, DIFFICULTY_WORLD_SIZE / 2);
